...
(defrule MAIN::mono-va-hacia-el-escritorio
   (mono sobre piso)
   (escritorio sobre piso)
   (banana colgada-en techo)
   (escritorio no-debajo banana)
...
(defrule MAIN::mono-arrastra-el-escritorio-debajo-banana
...
(defrule MAIN::mono-levanta-el-escritorio-debajo-banana
   (mono cerca escritorio)
   ?basura1 <- (escritorio no-debajo banana)
...
(defrule MAIN::mono-va-hacia-la-silla-1
   (mono sobre piso)
   (silla sobre piso)
...
(defrule MAIN::mono-va-hacia-la-silla
   (mono sobre piso)
   (silla sobre piso)
   (escritorio debajo banana)
   (mono lejos escritorio)
...
(defrule MAIN::mono-levanta-la-silla
...
(defrule MAIN::mono-va-hacia-el-escritorio-con-silla
   (mono con silla)
   ?basura1 <- (mono lejos escritorio)
...
(defrule MAIN::mono-pone-la-silla-sobre-el-escritorio
...
(defrule MAIN::mono-se-sube-al-escritorio
...
(defrule MAIN::mono-se-sube-a-la-silla
...
(defrule MAIN::mono-agarra-banana
...
(defrule MAIN::impresion-del-plan
   (pasos ?plan)
   =>
